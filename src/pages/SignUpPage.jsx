      ...
      <main className="flex-1 flex items-center justify-center px-6 py-32">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-extrabold text-on-surface tracking-tight">시작해볼까요</h1>
            <p className="text-on-surface-variant mt-2 text-sm">나만의 맞춤 식단 여정을 시작하세요</p>
          </div>
          ...
          <p className="text-center text-sm text-on-surface-variant mt-6">
            이미 계정이 있으신가요?{' '}
            <Link to="/login" className="font-bold text-primary hover:opacity-70 transition-opacity">
              로그인
            </Link>
          </p>
        </div>
