 ...
 *   onChatThreadStart  : 새 채팅 버튼 → MainPage.startChatThread
 *   chatThreads        : 채팅 스레드 목록 (MainPage의 useChatThreads에서 관리)
 *   onChatThreadSelect : 스레드 클릭   → MainPage.loadChatThread
